    ...
    <div class="container small-header">
      <div class="tt-header-holder">
        <div class="tt-col-obj tt-obj-logo">
          <!-- logo -->
          <a class="tt-logo tt-logo-alignment" href="index.html"><img src="<?php echo base_url('assets') ?>/images/custom/logo.png" alt=""></a>
          <!-- /logo -->
        </div>
                            ...
                            <div class="row tt-col-list">
                              <div class="col-sm-4">
                                <a href="listing-right-column.html" class="tt-title-submenu">
                                  TOPS
                                  <img  src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/custom/header-category-01.jpg" alt="">
                                </a>
                                <ul class="tt-megamenu-submenu">
                              ...
                              <div class="col-sm-4">
                                <a class="tt-title-submenu" href="listing-right-column.html">
                                  ACCESSORIES
                                  <img  src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/custom/header-category-03.jpg" alt="">
                                </a>
                                <ul class="tt-megamenu-submenu">
                                  <li><a href="listing-right-column.html">Hats</a></li>
                                  <li><a href="listing-right-column.html">Scarves &amp; Snoods</a></li>
                  ...
                  <li class="dropdown">
                    <div class="tt-col-obj tt-obj-search-type2">
                      <div class="tt-search-type2">
                        <!-- tt-search -->
                        <form action="http://softali.net/search" method="get" role="search">
                          <i class="icon-f-85"></i>
                    ...
                    <div class="tt-cart-content">
                      <div class="tt-cart-list">
                        ...
                        <div class="tt-item">
                          <a href="product.html">
                            <div class="tt-item-img">
                              <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/product/product-02.jpg" alt="">
                            </div>
                            <div class="tt-item-descriptions">
                              <h2 class="tt-title">Flared Shift Dress</h2>
                              <ul class="tt-add-info">
      ...
      <div class="row flex-sm-row-reverse tt-layout-promo-box">
          ...
          <div class="row">
            <div class="col-sm-6">
              <a href="listing-left-column.html" class="tt-promo-box tt-one-child hover-type-2">
                <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/promo/index04-promo-img-02.jpg" alt="">
                <div class="tt-description">
                  <div class="tt-description-wrapper">
            ...
            <div class="col-sm-6">
              <a href="listing-left-column.html" class="tt-promo-box tt-one-child hover-type-2">
                <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/promo/index04-promo-img-03.jpg" alt="">
                <div class="tt-description">
                  <div class="tt-description-wrapper">
                    <div class="tt-background"></div>
            ...
            <div class="col-sm-12">
              <a href="listing-left-column.html" class="tt-promo-box tt-one-child">
                <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/promo/index04-promo-img-04.jpg" alt="">
                <div class="tt-description">
                  <div class="tt-description-wrapper">
                    <div class="tt-background"></div>
        ...
        <div class="col-sm-12 col-md-6">
          <a href="listing-left-column.html" class="tt-promo-box">
            <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/promo/index04-promo-img-01.jpg" alt="">
            <div class="tt-description">
              <div class="tt-description-wrapper">
                <div class="tt-background"></div>
        ...
        <div class="tab-content">
            ...
            <div class="tt-carousel-products row arrow-location-tab tt-alignment-img tt-collection-listing slick-animated-show-js">
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-14.jpg" alt=""></div>
                  <div class="tt-description">
              ...
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-46.jpg" alt=""></div>
                  <div class="tt-description">
              ...
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-45.jpg" alt=""></div>
                  <div class="tt-description">
              ...
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-23.jpg" alt=""></div>
                  <div class="tt-description">
          ...
          <div class="tab-pane" id="tt-tab-02" role="tabpanel">
            <div class="tt-carousel-products row arrow-location-tab tt-alignment-img tt-collection-listing slick-animated-show-js">
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-26.jpg" alt=""></div>
                  <div class="tt-description">
                    <h2 class="tt-title">Pants</h2>
                    <ul class="tt-add-info">
                      <li>22 PRODUCTS</li>
              ...
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-11.jpg" alt=""></div>
                  <div class="tt-description">
                    <h2 class="tt-title">Sweaters</h2>
                    <ul class="tt-add-info">
                      <li>28 PRODUCTS</li>
          ...
          <div class="tab-pane fade" id="tt-tab-03" role="tabpanel">
            <div class="tt-carousel-products row arrow-location-tab tt-alignment-img tt-collection-listing slick-animated-show-js">
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-10.jpg" alt=""></div>
                  <div class="tt-description">
                    <h2 class="tt-title">Jackets &amp; Outerwear</h2>
                    <ul class="tt-add-info">
                      <li>35 PRODUCTS</li>
              ...
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-16.jpg" alt=""></div>
                  <div class="tt-description">
                    <h2 class="tt-title">Shirts &amp; Tops</h2>
                    <ul class="tt-add-info">
                      <li>45 PRODUCTS</li>
          ...
          <div class="tab-pane fade" id="tt-tab-05" role="tabpanel">
            <div class="tt-carousel-products row arrow-location-tab tt-alignment-img tt-collection-listing slick-animated-show-js">
              ...
              <div class="col-2 col-md-4 col-lg-3">
                <a href="#" class="tt-collection-item">
                  <div class="tt-image-box"><img src="<?php echo base_url('assets') ?>/images/product/product-27.jpg" alt=""></div>
                  <div class="tt-description">
                    <h2 class="tt-title">Shirts &amp; Tops</h2>
                    <ul class="tt-add-info">
                      <li>45 PRODUCTS</li>
          ...
          <div class="tab-pane active" id="tt-tab01-01">
            <div class="tt-carousel-products row arrow-location-tab tt-alignment-img tt-layout-product-item slick-animated-show-js">
              ...
              <a href="#" class="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></a>
                    <a href="product.html">
                      <span class="tt-img"><img src="<?php echo base_url('assets') ?>/images/product/product-20.jpg" alt=""></span>
                      <span class="tt-img-roll-over"><img src="<?php echo base_url('assets') ?>/images/product/product-20-01.jpg" alt=""></span>
              ...
              <a href="#" class="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></a>
                    <a href="product.html">
                      <span class="tt-img"><img src="<?php echo base_url('assets') ?>/images/product/product-02.jpg" alt=""></span>
                      <span class="tt-img-roll-over"><img src="<?php echo base_url('assets') ?>/images/product/product-02-02.jpg" alt=""></span>
                    </a>
                  </div>
                  <div class="tt-description">
                    <div class="tt-row">
              ...
              <a href="#" class="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></a>
                    <a href="product.html">
                      <span class="tt-img"><img src="<?php echo base_url('assets') ?>/images/product/product-22.jpg" alt=""></span>
                      <span class="tt-img-roll-over"><img src="<?php echo base_url('assets') ?>/images/product/product-22-01.jpg" alt=""></span>
                    </a>
                  </div>
                  <div class="tt-description">
                    <div class="tt-row">
              ...
              <a href="#" class="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></a>
                    <a href="product.html">
                      <span class="tt-img"><img src="<?php echo base_url('assets') ?>/images/product/product-24.jpg" alt=""></span>
                      <span class="tt-img-roll-over"><img src="<?php echo base_url('assets') ?>/images/product/product-24-01.jpg" alt=""></span>
                      <span class="tt-label-location">
              ...
              <a href="#" class="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></a>
                    <a href="product.html">
                      <span class="tt-img"><img src="<?php echo base_url('assets') ?>/images/product/product-17.jpg" alt=""></span>
                      <span class="tt-img-roll-over"><img src="<?php echo base_url('assets') ?>/images/product/product-17-01.jpg" alt=""></span>
                      <span class="tt-label-location">
                        <span class="tt-label-new">New</span>
                      </span>
                    </a>
          ...
          <div class="row">
            <div class="col-12 col-md-5 col-lg-6">
              <div class="tt-mobile-product-slider arrow-location-center">
                <div><img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/product/product-01.jpg" alt=""></div>
                <div><img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/product/product-01-02.jpg" alt=""></div>
                <div><img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/product/product-01-03.jpg" alt=""></div>
                <div><img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/product/product-01-04.jpg" alt=""></div>
                <div>
                    ...
                    <ul class="tt-options-swatch options-large">
                      <li><a class="options-color" href="#">
                        <span class="swatch-img">
                          <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/custom/texture-img-01.jpg" alt="">
                        </span>
                        <span class="swatch-label color-black"></span>
                      </a></li>
                      <li class="active"><a class="options-color" href="#">
                        <span class="swatch-img">
                          <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/custom/texture-img-02.jpg" alt="">
                        </span>
                        <span class="swatch-label color-black"></span>
                      </a></li>
                      <li><a class="options-color" href="#">
                        <span class="swatch-img">
                          <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/custom/texture-img-03.jpg" alt="">
                        </span>
                        <span class="swatch-label color-black"></span>
                      </a></li>
                      <li><a class="options-color" href="#">
                        <span class="swatch-img">
                          <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/custom/texture-img-04.jpg" alt="">
                        </span>
                        <span class="swatch-label color-black"></span>
                      </a></li>
                      <li><a class="options-color" href="#">
                        <span class="swatch-img">
                          <img src="<?php echo base_url('assets') ?>/images/loader.svg" data-src="<?php echo base_url('assets') ?>/images/custom/texture-img-05.jpg" alt="">
                        </span>
                        <span class="swatch-label color-black"></span>
                      </a></li>
                    </ul>
...
<!-- Mirrored from softali.net/victor/wookie/html/index-04.html by HTTrack Website Copier/3.x [XR&CO'2010], Fri, 18 Jan 2019 14:23:05 GMT -->
</html>