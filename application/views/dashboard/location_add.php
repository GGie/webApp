...
<form method="post" action="<?php echo base_url('dashboard/location/save') ?>" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="alamat_name" name="alamat_name" placeholder="Alamat Rumah/Alamat Kontrakan" autocomplete="off" required="true" maxlength="30">
  </div>
...
<div class="row">
  <div class="col-lg-5">
    ...
    <div class="input-group">
      <input type="text" id="penerima" name="penerima" class="form-control" value="" placeholder="Tulis Nama Kamu" required="true" maxlength="50">
    </div>
  </div>
  <div class="col-lg-3">
    <label>Nomor Handphone</label>
    <div class="input-group">
      <input type="number" id="no_hp" name="no_hp" class="form-control" placeholder="08xx" required="true" maxlength="16">
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-lg-8">
    ...
    <div class="input-group">
		<select id="pro_kec" name="pro_kec" class="form-control" style="width:300px" >
		</select>
    </div>
  </div>
  ...
  <div class="col-lg-3">
    ...
    <div class="input-group">
      <input type="number" id="kode_pos" name="kode_pos" class="form-control" value="" required="true" maxlength="10">
    </div>
  </div>
</div>
...
<div class="form-group">
		...
		<textarea class="form-control" id="alamat_detail" name="alamat_detail" placeholder="Nama Jalan, Nomor Rumah RT/RW" required="true" maxlength="350"></textarea>
</div>
