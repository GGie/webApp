...
<div class="form-group">
  ...
  <input type="text" class="form-control" id="password" name="password" placeholder="Password" value="" autocomplete="off" required="true" minlength="6" maxlength="50">
</div>

<div class="form-group">
  <label for="password2">Konfirmasi Password Baru</label>
  <input type="text" class="form-control" id="password2" name="password2" placeholder="Konfirmasi Password Baru" value="" autocomplete="off" minlength="6" maxlength="15">
</div>

<div class="form-group">
  <label for="password_old">Password Lama</label>
  <input type="text" class="form-control" id="password_old" name="password_old" placeholder="Password Lama" value="" autocomplete="off" maxlength="15">
</div>
