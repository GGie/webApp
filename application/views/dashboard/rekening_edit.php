...
<form method="post" action="<?php echo base_url('dashboard/rekening/update') ?>" enctype="multipart/form-data">
...
<div class="row">
  <div class="col-lg-12" style="margin-bottom: 18px">
    ...
    <input type="hidden" name="link_ref" value="<?php echo @link_ref()?>">
      ...
      <option value="<?php echo $data->rekening_id ?>"><?php echo $data->bankName ?></option>
		</select>
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <input type="text" class="form-control" id="bankAccount" name="bankAccount" placeholder="Nomor Rekening" value="<?php echo $data->bankAccount ?>" autocomplete="off" required="true" maxlength="30">
</div>

<div class="form-group">
  <label for="beneficiary">Nama Pemilik Rekening</label>
  <input type="text" class="form-control" id="beneficiary" name="beneficiary" placeholder="Nama Pemilik Rekening" value="<?php echo $data->beneficiary ?>" autocomplete="off" required="true" maxlength="50">
</div>
