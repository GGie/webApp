...
<div id="content-block">
		...
		<div class="container-fluid custom-container pt-4 pb-4">
			<div class="row">
...
<form method="post" action="<?php echo base_url('dashboard/location/update') ?>" enctype="multipart/form-data">
    ...
    <div class="material-textfield normal form-control mt-4">
      <input type="text" id="alamat_name" name="alamat_name" value="<?php echo $data->alamat_name; ?>" placeholder="Alamat Rumah/Alamat Kontrakan" autocomplete="off" required="true" maxlength="30">
      <label data-content="Nama Produk"></label>
    </div>

    <div class="material-textfield normal form-control mt-4">
      <input type="text" id="penerima" name="penerima" value="<?php echo $data->penerima; ?>" placeholder="Tulis Nama Kamu" required="true" maxlength="50">
      <label data-content="Nama Penerima"></label>
    </div>

    <div class="material-textfield normal form-control mt-4">
      <input type="number" id="no_hp" name="no_hp"  value="<?php echo $data->no_hp; ?>" placeholder="Nomor Handphone Kamu" required="true" maxlength="16">
    ...
    <div class="material-textfield normal form-control mt-4">
      <input type="number" id="kode_pos" name="kode_pos" value="<?php echo $data->kode_pos; ?>" value="" required="true" maxlength="10">
  ...
  <div class="form-group">
    ...
    font-weight: bold;color: #000">Alamat Rumah</label>
      ...
      ><?php echo $data->alamat_detail; ?></textarea>
  </div>
