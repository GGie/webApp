...
<form method="post" id="form" action="<?php echo base_url('dashboard/account/update_info') ?>" enctype="multipart/form-data">

    <div class="material-textfield normal form-control mt-4">
      <input type="text" id="fullname" name="fullname" placeholder="Nama Lengkap" value="<?php echo $user->fullname ?>" autocomplete="off" required="true" minlength="6" maxlength="50">
      <label data-content="Nama Lengkap"></label>
    </div>

    <div class="material-textfield normal form-control mt-4">
      <input type="date" id="birthday" name="birthday" placeholder="Tanggal Lahir" value="<?php echo $user->birthday ?>" autocomplete="off" minlength="6" maxlength="15">
      <label data-content="Tanggal Lahir"></label>
    </div>

<div class="form-group">
        <label for="gender" class="pl-2 normal" style="font-size: 14px;
    color: #eee;
    font-weight: bold;color: #000">Jenis Kelamin</label>
