...
<div class="form-group">
  ...
  <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Nama Lengkap" value="<?php echo $user->fullname ?>" autocomplete="off" required="true" minlength="6" maxlength="50">
</div>

<div class="form-group">
  <label for="birthday">Tanggal Lahir</label>
  <input type="date" class="form-control" id="birthday" name="birthday" placeholder="Tanggal Lahir" value="<?php echo $user->birthday ?>" autocomplete="off" minlength="6" maxlength="15">
</div>
