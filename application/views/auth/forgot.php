...
.forgot-password:focus{
    color: rgb(12, 97, 33);
        ...
        <div class="card card-container">
            ...
            <form class="form-signin" method="post" action="<?php echo base_url('auth/forgot') ?>">
                <span id="reauth-email" class="reauth-email"></span>
                <input type="email" id="inputEmail" name="txtemail" class="form-control" placeholder="Email address" required autofocus>
                <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit"><?php echo $this->lang->line('send'); ?></button>
            </form><!-- /form -->
