...
<div id="tt-pageContent">
	<div class="container-indent tt-hidden-desctope">
		<div class="container">
			<div class="row" style="">
				<div class="col-6 col-md-6 col-lg-6 col-xl-6">
					<a href="<?php echo base_url('dashboard/product_list') ?>">
						<div class="shadow-sm"><i class="icon-2x icon-f-46"> </i> Daftar Jual</div>
					</a>
				</div>
				<div class="col-6 col-md-6 col-lg-6 col-xl-6">
					<a href="<?php echo base_url('dashboard/product_buy') ?>">
			...
			<div class="row" style="">
				<div class="col-6 col-md-6 col-lg-6 col-xl-6">
					<a href="<?php echo base_url('dashboard/product/add') ?>">
						<div class="shadow-sm"><i class="icon-2x icon-f-69"> </i> Tambah Product</div>
					</a>
				</div>
				<div class="col-6 col-md-6 col-lg-6 col-xl-6">
					<a href="<?php echo base_url('dashboard/location_list') ?>">
...
<div id="tt-pageContent">
	<div class="container-indent">
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-lg-3 col-xl-4 leftColumn aside">
												      ...
												      <td>
												        ...
												        <div class="tt-empty-search" style="padding: 10px!important">
												          ...
												          <img src="<?php echo base_url('assets/images/icon/Shopping9.png') ?>" width="35%">
												                    ...
												                    <br><h3 style="color: grey">Belum Ada Chat</h3>
												        </div>
												      </td>
												    </tr>
												   </table>
